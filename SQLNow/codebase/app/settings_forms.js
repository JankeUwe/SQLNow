window.settingsFormStruct = {
    settings: [
            { type: "settings", position: "label-right", inputWidth: 130, labelAlign: "left" },
            {
                _idd: "100",
                type: "block",
                width: "auto",
                ...
                list: [
                    ...
                    { type: "input", label: "Fileversion", value: "", name: "Fileversion", required: true },
                    { _idd: "312", type: "newcolumn", offset: "60" },
                    {
                        _idd: "260",
                        type: "input",
                        label: "FileSender",
                    ...
                    },
                    {
                        ...
                        label: "FileSubcriber",
                        value: "",
                        name: "FileSubcriberID"
                    },
                    { _idd: "330", type: "input", label: "Department", value: "", name: "Department", required: true },
                    { type: "newcolumn", offset: "60" },
                    { type: "input", label: "Host", value: "", name: "host", required: true, validate: "NotEmpty" },
                    { type: "input", label: "Port", value: "", name: "port", required: true, validate: "NotEmpty,ValidNumeric" },
                    { type: "input", label: "Directory", value: "", name: "workingdirectory", required: true , validate:"NotEmpty"},
                    { type: "input", label: "Username", value: "", name: "username", required: true, validate: "NotEmpty" },
                    { type: "password", label: "Password", value: "", name: "password", required: true, validate: "NotEmpty" }
                ]
            }
    ],
